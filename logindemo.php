...
<body>
    <div class="container">
        <div class=" col-md-6 mx-auto align-self-center signup-right">
            <div class="card-body">
                <h3 class="text-center"><b>Welcome Back! Login Here</b></h3>
                <form action="" method="POST">
                      ...
                      <div class="custom-control custom-checkbox my-1 mr-sm-2">
                        ...
                        <label class="custom-control-label" for="customC">Remember Me</label>
                      </div>
                      <div class="text-left" style="color: #0091FF;"><a href="forgetPassword.php"> Forgot Password?</a></div>                      
                      <button type="submit" value="POST" name="submit" class="btn btn-lg btn-primary">Submit</button>
                </form>
                <br><br>
